...
class TeamView(View):
    ...
    def post(self, request):
        ...
        try:
            ...
            messages.error(
                request, f'Team Creation Failed. Error - {e}')
...
class TeamDetailView(View):
        ...
        try:
            ...
            if team_instance.created_by == user or team_instance.assigned_user.filter(pk=user.pk).exists():
                ...
                team_tasks = Task.objects.filter(
                    team__title=team_instance.title)
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            messages.error(
                request, f'Team Update Failed. Error - {e}')
